...
const navGroups = [
    {
        ...
        items: [
            { label: 'Analytics', icon: 'pi pi-chart-line', to: '/admin/dashboard' },
            {
                ...
                key: 'hiring',
                subItems: [
                    { label: 'Job Vacancies', icon: 'pi pi-plus-circle', to: '/admin/jobs' },
                    { label: 'Applicants List', icon: 'pi pi-users', to: '/admin/applicants' },
                    { label: 'Evaluation', icon: 'pi pi-list', to: '/admin/rankings' },
        ...
        items: [
            {
                ...
                key: 'accounts',
                subItems: [
                    { label: 'Users List', icon: 'pi pi-users', to: '/admin/users' },
                    { label: 'Roles & Permissions', icon: 'pi pi-shield', to: '/admin/roles' },
                    { label: 'Audit Logs', icon: 'pi pi-history', to: '/admin/logs' },
                ]
            },
